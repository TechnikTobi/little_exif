...
impl Into<uR64> for f64 {
    fn into(self) -> uR64 {
        f64_to_rational64u(self)
    }
}
impl Into<iR64> for f64 {
    fn into(self) -> iR64 {
        f64_to_rational64s(self)
    }
}

impl Into<uR64> for u32 {
    fn into(self) -> uR64 {
        f64_to_rational64u(self as f64)
    }
}
impl Into<iR64> for u32 {
    fn into(self) -> iR64 {
        f64_to_rational64s(self as f64)
    }
}
impl Into<iR64> for i32 {
    fn into(self) -> iR64 {
        f64_to_rational64s(self as f64)
    }
}

impl Into<f64> for uR64 {
    fn into(self) -> f64 {
        rational64u_to_f64(&self)
    }
}
impl Into<f64> for iR64 {
    fn into(self) -> f64 {
        rational64s_to_f64(&self)
    }
}

impl Into<u32> for uR64 {
    fn into(self) -> u32 {
        rational64u_to_f64(&self) as u32
    }
}
impl Into<u32> for iR64 {
    fn into(self) -> u32 {
        rational64s_to_f64(&self) as u32
    }
}
impl Into<i32> for iR64 {
    fn into(self) -> i32 {
        rational64s_to_f64(&self) as i32
    }
}
