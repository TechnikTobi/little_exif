...
pub trait U8conversion<T> {
    ...
    fn from_u8_vec(u8_vec: &Vec<u8>, endian: &Endian) -> T;
}
...
macro_rules! build_u8conversion {
    (
        ...
        impl U8conversion<$type> for $type {
            ...
            fn from_u8_vec(u8_vec: &Vec<u8>, endian: &Endian) -> $type {
...
impl U8conversion<String> for String {
    ...
    fn from_u8_vec(u8_vec: &Vec<u8>, _endian: &Endian) -> String {
...
impl U8conversion<uR64> for uR64 {
    ...
    fn from_u8_vec(u8_vec: &Vec<u8>, endian: &Endian) -> uR64 {
        if u8_vec.len() != 8 {
...
impl U8conversion<iR64> for iR64 {
    ...
    fn from_u8_vec(u8_vec: &Vec<u8>, endian: &Endian) -> iR64 {
        if u8_vec.len() != 8 {
            panic!("from_u8_vec (r64u): Mangled EXIF data encountered!")
        }
...
macro_rules! build_vec_u8conversion {
    (
        ...
        impl U8conversion<Vec<$type>> for Vec<$type> {
            ...
            fn from_u8_vec(u8_vec: &Vec<u8>, endian: &Endian) -> Vec<$type> {
