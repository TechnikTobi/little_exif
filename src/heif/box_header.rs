...
impl BoxHeader {
    ...
    pub(super) fn get_box_size(&self) -> usize {
    ...
    pub(super) fn get_header_size(&self) -> usize {
        return self.header_size;
    }

    pub(super) fn set_box_size(&mut self, new_size: usize) {
        self.box_size = new_size;
    }

    pub(super) fn set_box_type_via_string(&mut self, new_type: String) {
        self.box_type = BoxType::from_4_bytes(new_type.as_bytes().try_into().unwrap());
    }
