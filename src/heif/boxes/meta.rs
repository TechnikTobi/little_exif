...
impl MetaBox {
    pub(crate) fn get_item_info_box(&self) -> &ItemInfoBox {
        return match self
            .other_boxes
            .iter()
    ...
    pub(crate) fn get_item_location_box(&self) -> &ItemLocationBox {
        return match self
            .other_boxes
            .iter()
    ...
    pub(crate) fn get_item_location_box_mut(&mut self) -> &mut ItemLocationBox {
        return match self
            .other_boxes
            .iter_mut()
            .find(|b| b.get_header().get_box_type() == BoxType::iloc)
    ...
    pub(crate) fn create_new_item_reference_box_if_none_exists_yet(&mut self) {
