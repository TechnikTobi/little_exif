...
impl HeifContainer {
    ...
    fn get_meta_box_mut(&mut self) -> &mut MetaBox {
        return match self
            .boxes
            .iter_mut()
            .find(|b| b.get_header().get_box_type() == BoxType::meta)
    ...
    fn get_exif_data_pos_and_len(&self, exif_item_id: u16) -> (u64, u64) {
        let exif_item = self
            .get_meta_box()
    ...
    pub(super) fn generic_write_metadata(
        ...
        let (old_exif_pos, old_exif_len) = id
            .as_ref()
