...
impl ImageFileDirectory {
    ...
    pub fn get_generic_ifd_nr(&self) -> u32 {
        return self.belongs_to_generic_ifd_nr;
    }

    pub fn get_ifd_type(&self) -> ExifTagGroup {
        return self.ifd_type;
    }

    pub fn get_offset_tag_for_parent_ifd(&self) -> Option<(ExifTagGroup, ExifTag)> {
        match self.ifd_type {
    ...
    pub fn get_ifd_type_for_offset_tag(tag: &ExifTag) -> Option<ExifTagGroup> {
        match tag {
