...
{
    let path_orig = Path::new("tests/resources/issue_000065/20160513-A0012+001.tiff");
    let path_copy = Path::new("tests/resources/issue_000065/20160513-A0012+001_copy.tiff");
