...
fn new_from_path_panic_not_existent() {
    let _ = Metadata::new_from_path(Path::new("sample2.png")).unwrap();
}

#[test]
#[should_panic(
    expected = "called `Result::unwrap()` on an `Err` value: Custom { kind: Other, error: \"Could not determine file type when reading file!\" }"
)]
fn new_from_path_panic_no_extension() {
    let _ = Metadata::new_from_path(Path::new("tests/sample0")).unwrap();
}

#[test]
#[should_panic(
    expected = "called `Result::unwrap()` on an `Err` value: Custom { kind: Unsupported, error: \"Unsupported file type: txt - Unknown file type: txt\" }"
)]
fn new_from_path_panic_not_supported() {
...
#[test]
fn read_from_file_webp() -> Result<(), std::io::Error> {
    ...
    if let Some(iso_tag) = metadata.get_tag(&ExifTag::ISO(vec![0])).next() {
        assert_eq!(
            from_u8_vec_to_u32_le(&iso_tag.value_as_u8_vec(&little_exif::endian::Endian::Little)),
            2706
        );
    } else {
...
#[test]
fn read_from_file_jxl() -> Result<(), std::io::Error> {
...
#[test]
fn read_from_file_tiff() -> Result<(), std::io::Error> {
...
#[test]
fn read_from_file_avif() -> Result<(), std::io::Error> {
...
#[test]
fn read_from_vec_webp() -> Result<(), std::io::Error> {
    return read_from_vec_generic(
        &read("tests/read_sample.webp").unwrap(),
        little_exif::filetype::FileExtension::WEBP,
    );
}

#[test]
fn read_from_vec_jpg() -> Result<(), std::io::Error> {
    return read_from_vec_generic(
        &read("tests/read_sample.jpg").unwrap(),
        little_exif::filetype::FileExtension::JPEG,
    );
}

#[test]
fn read_from_vec_jxl() -> Result<(), std::io::Error> {
    return read_from_vec_generic(
        &read("tests/with_exif.jxl").unwrap(),
        little_exif::filetype::FileExtension::JXL,
    );
}

fn get_test_metadata() -> Result<Metadata, std::io::Error> {
    ...
    metadata.set_tag(ExifTag::ExposureProgram(vec![1]));
    metadata.set_tag(ExifTag::ISO(vec![2706]));
    metadata.set_tag(ExifTag::Model("Testcam(1)".to_string()));
...
#[test]
fn clear_metadata_jxl() -> Result<(), std::io::Error> {
...
#[test]
fn file_clear_metadata_jxl() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn file_write_and_clear_metadata_jpg() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn file_clear_metadata_png() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn file_clear_metadata_avif() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn write_to_file_jpg() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn write_to_file_jxl_no_conversion() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn write_to_file_jxl_with_conversion() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn write_to_file_png() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[ignore]
#[test]
fn write_to_file_webp_simple_lossy() -> Result<(), std::io::Error> {
    ...
    copy(
        "tests/sample2_simple_lossy.webp",
        "tests/sample2_simple_lossy_copy.webp",
    )?;
...
#[test]
fn write_to_file_webp_simple_lossless() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
    ...
    copy(
        ...
        "tests/sample2_simple_lossless_copy.webp",
    )?;
...
#[test]
fn write_to_file_webp_extended() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn write_to_file_tiff_basic() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn write_to_file_avif_exif_box_already_existing() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn write_to_file_avif_no_exif_box_yet() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
...
#[test]
fn write_to_file_avif_no_iref() -> Result<(), std::io::Error> {
    // Remove file from previous run and replace it with fresh copy
    if let Err(error) = remove_file("tests/write_sample_no_iref_copy.avif") {
        println!("{}", error);
    }
    copy(
        "tests/write_sample_no_iref.avif",
        "tests/write_sample_no_iref_copy.avif",
    )?;
...
#[test]
fn compare_write_to_jpg() -> Result<(), std::io::Error> {
...
#[test]
fn compare_write_to_jxl() -> Result<(), std::io::Error> {
    return compare_write_to_generic(
        "tests/no_exif.jxl",
...
#[test]
fn compare_write_to_png() -> Result<(), std::io::Error> {
    return compare_write_to_generic(
        "tests/sample2.png",
...
#[test]
fn compare_write_to_webp_lossless() -> Result<(), std::io::Error> {
    return compare_write_to_generic(
        "tests/sample2_simple_lossless.webp",
...
#[test]
fn compare_write_to_webp_extended() -> Result<(), std::io::Error> {
    return compare_write_to_generic(
