...
read_exif_data_1()
{
    let path = Path::new("tests/resources/issue_000002/0010_A0420427.JPG");
...
read_exif_data_2()
{
    let file_path = Path::new("tests/resources/issue_000002/0010_A0420427.JPG");
...
-> Result<(), std::io::Error>
{
    let path_orig = Path::new("tests/resources/issue_000002/0010_A0420427.JPG");
    let path_copy = Path::new("tests/resources/issue_000002/0010_A0420427_copy.JPG");
